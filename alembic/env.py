...
from app.core.db_models import (
    PaperDraft, ReviewSuggestion, ChatConversation, ChatMessage,
    Subscription, UsageRecord, PaymentRecord
)
from app.core.user_models import User  # FastAPI Users authentication model
...
if DATABASE_URL.startswith("sqlite:///"):
    # For Alembic, we need the synchronous version
